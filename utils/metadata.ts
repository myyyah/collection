...
export async function uploadFolderToIPFS(folderPath: string): Promise<string> {
  const pinata = new pinataSDK({
    pinataApiKey: "64eb02a876d258e81fe8", //process.env.PINATA_API_KEY,
    pinataSecretApiKey: "060cbc41b67d096088fe7d72c6e2c971e9c42fa1e3abfc4a5701daae5fd20e44" //process.env.PINATA_API_SECRET,
  });
